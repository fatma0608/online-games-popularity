...
# ══════════════════════════════════════════════════════════════════
# TRAIN / TEST SPLIT
# ── IMPORTANT: we save the raw-dataframe indices so the NLP script
#    can use the EXACT same split.  The NLP script loads these files
#    instead of doing its own train_test_split().
# ══════════════════════════════════════════════════════════════════
...
# Save indices so nlp.py can reproduce the exact same split
...
print("  ./data/processed/idx_train.npy  ← used by nlp.py for aligned split")
print("  ./data/processed/idx_test.npy   ← used by nlp.py for aligned split")